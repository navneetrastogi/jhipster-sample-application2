...
public class ActivityResourceIntTest {
    ...
    private static final String DEFAULT_STUDENT_IDS = "AAAAAAAAAA";
    private static final String UPDATED_STUDENT_IDS = "BBBBBBBBBB";
    ...
    public void createActivity() throws Exception {
        ...
        assertThat(testActivity.getStudentIds()).isEqualTo(DEFAULT_STUDENT_IDS);
    }
    ...
    public void getAllActivities() throws Exception {
        ...
        restActivityMockMvc.perform(get("/api/activities?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].studentIds").value(hasItem(DEFAULT_STUDENT_IDS.toString())));
    }
    ...
    public void getActivity() throws Exception {
        ...
        restActivityMockMvc.perform(get("/api/activities/{id}", activity.getId()))
            ...
            .andExpect(jsonPath("$.studentIds").value(DEFAULT_STUDENT_IDS.toString()));
    }
    ...
    public void updateActivity() throws Exception {
        ...
        updatedActivity
            ...
            .studentIds(UPDATED_STUDENT_IDS);
        ...
        assertThat(testActivity.getStudentIds()).isEqualTo(UPDATED_STUDENT_IDS);
    }
