...
public class MilestoneRecordResource {
    ...
    @Timed
    public ResponseEntity<MilestoneRecord> getMilestoneRecord(@PathVariable String id) {
    ...
    @Timed
    public ResponseEntity<Void> deleteMilestoneRecord(@PathVariable String id) {
