...
public class ImmunizationRecordResource {
    ...
    @Timed
    public ResponseEntity<ImmunizationRecord> getImmunizationRecord(@PathVariable String id) {
    ...
    @Timed
    public ResponseEntity<Void> deleteImmunizationRecord(@PathVariable String id) {
