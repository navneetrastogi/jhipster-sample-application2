...
export class ConversationUpdate extends React.Component<IConversationUpdateProps, IConversationUpdateState> {
  ...
  render() {
    const { conversationEntity, loading, updating } = this.props;
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="jhipsterSampleApplication2App.conversation.home.createOrEditLabel">Create or edit a Conversation</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
