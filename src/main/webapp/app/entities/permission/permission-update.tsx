...
export class PermissionUpdate extends React.Component<IPermissionUpdateProps, IPermissionUpdateState> {
  ...
  render() {
    const { permissionEntity, loading, updating } = this.props;
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="jhipsterSampleApplication2App.permission.home.createOrEditLabel">Create or edit a Permission</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
